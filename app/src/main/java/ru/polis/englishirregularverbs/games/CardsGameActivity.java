package ru.polis.englishirregularverbs.games;
...
public class CardsGameActivity extends AbstractGameActivity{
    ...
    private int presentPart; //Текущий этап (0 - инфинитив, 1 - претеритум, 2 - перфект, 3 - если все глаголы повторены)
...
//        loadAd();
    ...
    private void showNextPart() {
        ...
        switch (presentPart){
            ...
            case 1:
                ...
                var4CardView.setCardBackgroundColor(colorWhite);
                verbFormsTextView.setText(getTextForResultTextView(presentPart));
                variants[0] = verbs[presentVerbNum].getPerfekt(); //Добавление правильного варианта
    ...
    private String getTextForResultTextView(int presentPart) {
        switch (presentPart){
            ...
            case 2:
                return verbs[presentVerbNum].getInfinitive() + " - " + verbs[presentVerbNum].getPrateritum() + " - " + verbs[presentVerbNum].getPerfekt();
        }
        return "";
    }
    ...
    private class AnswerListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (result) {
                ...
                if(presentPart == 2){ //Перед переходом к следующему глаголу показывает правильное спряжение
                    verbFormsTextView.setText(getTextForResultTextView(presentPart));
                }
        ...
        private boolean checkResult(String answer) {
            ...
            switch (presentPart) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    rightAnswer = verbs[presentVerbNum].getPerfekt();
                    break;
            }
