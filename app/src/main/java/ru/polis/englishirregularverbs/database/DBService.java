package ru.polis.englishirregularverbs.database;
...
import ru.polis.englishirregularverbs.enums.Language;
import ru.polis.englishirregularverbs.objects.Result;
import ru.polis.englishirregularverbs.objects.Verb;
...
public class DBService {
    ...
    public void addWordsInDB(ArrayList<String[]> listOfWords) {
        ...
        if(!cursor.moveToFirst()) {
            for (String[] line : listOfWords) {
                ...
                contentValues.put(Language.RUS.getNameForDB(), line[9]);
                contentValues.put(Language.GER.getNameForDB(), line[10]);
    ...
    public Verb[] getRandomVerbs(int verbCount, Language language) throws NotEnoghtVerbsException {
        ...
        for(int i : setRandomInt){
            ...
            String prateritum = cursor.getString(2);
            String perfekt = cursor.getString(3);
            String translate = cursor.getString(4);
            String prat_miss_1 = cursor.getString(5);
            String prat_miss_2 = cursor.getString(6);
            String prat_miss_3 = cursor.getString(7);
            String perf_miss_1 = cursor.getString(8);
            String perf_miss_2 = cursor.getString(9);
            String perf_miss_3 = cursor.getString(10);
            Verb verb = new Verb(id, infinitive, prateritum, perfekt, translate, prat_miss_1, prat_miss_2, prat_miss_3, perf_miss_1, perf_miss_2, perf_miss_3);
            verbs[index] = verb;
            index++;
